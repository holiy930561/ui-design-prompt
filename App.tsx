  ...
  const renderCategoryContent = (key: string) => {
    ...
    const CustomButton = () => (
      <button
        ...
        className={`
          relative px-4 py-3 rounded-xl text-base font-medium text-left transition-all duration-200 w-full
          ...
          <div className="space-y-6">
            {category.groups.map((group, idx) => (
              <div key={idx} className="rounded-2xl p-1">
                <h4 className="text-sm font-bold text-slate-500 uppercase tracking-wide mb-3 ml-1 flex items-center gap-2 font-sans">
          ...
          <div className="pt-1 animate-fade-in-up">
            <div className="relative group">
              ...
              <input
                ...
                className={`
                  block w-full pl-10 pr-4 py-3 rounded-xl text-sm transition-all duration-200 outline-none
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 mb-5 group">
                    ...
                    <div>
                      <h2 className={`text-lg font-bold transition-colors ${isSelected ? 'text-violet-900' : 'text-slate-900'}`}>
